...
Especializado en: Arquitectura cloud-native (AWS Lambda, DynamoDB, API Gateway) • Desarrollo móvil (Kotlin, Swift, Jetpack Compose) • Infraestructura como Código (AWS CDK) • Automatización CI/CD • Diseño de microservicios • Desarrollo Asistido por IA (Amazon Q / Kiro)

## Experiencia Laboral

### Amazon, Minneapolis MN
**Ingeniero de Software L5** | Marzo 2021 - Marzo 2026  
*Servicios de Transporte de Amazon (ATS)*

Arquitecté y desarrollé soluciones móviles y backend de extremo a extremo para la red de transporte de milla media de Amazon sirviendo a más de 50,000 socios de transporte en Norteamérica, Europa y Japón. Contribuidor clave en un equipo de 13 ingenieros, mentoreando ingenieros junior (50%+ del equipo) y dirigiendo decisiones técnicas para servicios que procesan millones de transacciones diarias.

**Logros Principales:**
- Arquitecté y construí servicios backend serverless escalables usando AWS Lambda, DynamoDB y API Gateway, procesando millones de transacciones diarias para emparejamiento de cargas en tiempo real, operaciones de socios y orquestación logística
- Diseñé e implementé infraestructura AWS CDK con monitoreo integral, alarmas y alertas automatizadas asegurando 99.9% de cumplimiento de SLA en despliegues multi-región
...
- Lideré la modernización de la aplicación móvil Relay (calificación de 4.7 estrellas en ambas tiendas de aplicaciones), migrando Android a Jetpack Compose e iOS a SwiftUI mientras apoyo a más de 50,000 usuarios activos
- Proporcioné apoyo continuo y mejoras para aplicaciones móviles de producción que permiten a socios de transporte descubrir y ejecutar cargas de productos a través de la red logística de Amazon
- Lideré revisiones de diseño y mentoría técnica para ingenieros junior a través de revisiones de código, programación en pareja y guía arquitectónica
- Aproveché el desarrollo asistido por IA (Amazon Q / Kiro) para acelerar la entrega de funcionalidades móviles y backend, mejorar la calidad del código, y optimizar el ciclo de vida del desarrollo

**Tecnologías:** AWS (Lambda, DynamoDB, API Gateway, CDK, S3, CloudWatch, EventBridge, Step Functions), Java, Kotlin, Node.js, TypeScript, Spring Boot, Android, iOS, Jetpack Compose, SwiftUI, React, Desarrollo Asistido por IA (Amazon Q / Kiro)

### ICF (Olson/Next), Minneapolis MN
**Arquitecto de Software Jr.** | Septiembre 2019 - Marzo 2021  
**Ingeniero de Software Sr.** | Julio 2016 - Septiembre 2019  
...
Desarrollé aplicación de escritorio para pruebas eléctricas automatizadas de prototipos de PCB para Polaris y TrailTech. La aplicación se interfaza con hardware FTDI personalizado para realizar pruebas de aseguramiento de calidad automatizadas. Desplegada exitosamente en líneas de producción en China en Mayo 2025.
...
**Tecnologías:** Java, JAX-RS, Mongo# Alexandro Blanco Santana
